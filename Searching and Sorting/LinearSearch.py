...
# Given an array arr[] of n elements, make search function to search a given element x in arr[].
# Time complexity O(n)
# Approach: Search the list with 2 different sides under same loop.
...
# This code help from geeksforgeeks
